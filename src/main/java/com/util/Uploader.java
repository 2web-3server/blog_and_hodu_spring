...
public class Uploader {
    public String upload_image(HttpServletRequest request, HttpServletResponse response) throws Exception{
        try {
            ...
            // 확장자 체크
            int nCnt = 0; for(int i=0; i<allowFileArr.length; i++) {
            ...
            if(nCnt == 0) {
                ...
                //디렉토리 설정 및 업로드
                // 파일경로
                String filePath = new ClassPathResource("/static/upload/blog/images").getFile().getAbsolutePath();
//                String filePath ="src/main/resources/static/upload/blog/images/";
                filePath +="/";
